...
# /esd/esd01/data/mschmid/lpj_git/lpj-guess/guess
# as a parallel job using PBS on Simba.
#
# Created automatically on Mon Jun 25 14:22:30 CEST 2018
# 
# Usage: 
#
...
mpiexec -comm mpich-p4 /esd/esd01/data/mschmid/lpj_git/lpj-guess/guess -parallel -input $INPUT_MODULE $INSFILE
