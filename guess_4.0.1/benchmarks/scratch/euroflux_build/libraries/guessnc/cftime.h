...
enum CalendarType {
	...
	NO_LEAP,
	PALEO				 // cw SubPixel use this if you habe a B.P./BP calendar, behaves like NO_LEAP
};
...
// cw SubPixel get offset years from BP calendar
...
public:
	...
	/// \returns year
	int get_year() const { return year + paleo_offset; }
...
private:
	...
	/// paleo calendar offset (default: 0, in years)
	int paleo_offset;
