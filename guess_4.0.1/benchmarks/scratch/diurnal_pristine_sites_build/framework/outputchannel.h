...
public:
     ...
     /// cw add stand and patch yearly output
    
     virtual void finish_row(const Table& table, double lon, double lat,
                            int year, int day, int stand) = 0;
    
     virtual void finish_row(const Table& table, double lon, double lat,
                            int year, int day, int stand, int patch) = 0;
...
public:
     ...
     void finish_row(const Table& table, double lon, double lat,
                    int year, int day, int stand);

     void finish_row(const Table& table, double lon, double lat,
                    int year, int day, int stand, int patch);
    
private:
	 /// Help function to the two variants of finish_row above
	 void finish_row(const Table& table, double lon, double lat,
	                 int year, int day, bool print_day, int stand, int patch);
...
public:
     ...
     /// cw new option: annual stand and patch rows
     OutputRows(OutputChannel* output_channel, double longitude, double latitude, int year, int day, int stand);
     OutputRows(OutputChannel* output_channel, double longitude, double latitude, int year, int day, int stand, int patch);
