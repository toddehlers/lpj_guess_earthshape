...
void turnover_grass(Individual& indiv) {
	...
	double retransn_nextyear = cmass_leaf_pre_turnover * indiv.pft.turnover_leaf / cton_leaf_bg * indiv.pft.nrelocfrac +
		cmass_root_pre_turnover * indiv.pft.turnover_root / cton_root_bg * indiv.pft.nrelocfrac;
