...
/// cw SubPixel whether to run in landform mode.
extern bool run_landform;
/// cw SubPixel variable soil depth
extern bool sp_modifysoildepth;
/// cw SubPixel deep water access
extern bool ifdeepwater;
/// cw SubPixel universal sla calculation
extern bool ifuniversalsla;
/// cw SubPixel start detailed output at year spoutput_startyear / -1 all historic years
extern int spoutput_startyear;
/// cw SubPixel stepwidth for detailed output (1, no skip, 2 every second year etc.)
extern int spoutput_step;
...
extern xtring landform_state_path;
...
/// cw make baseflow_frac variable
extern double BASEFLOW_FRAC;
